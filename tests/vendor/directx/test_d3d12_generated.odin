...
verify_d3d12_helpers :: proc(t: ^testing.T) {
	expect_value(t, d3d12.D3D12_ENCODE_SHADER_4_COMPONENT_MAPPING(0, 1, 2, 3), 0x00001688)
	expect_value(t, d3d12.D3D12_DECODE_SHADER_4_COMPONENT_MAPPING(0, 0x00001688), 0x00000000)
	expect_value(t, d3d12.D3D12_DECODE_SHADER_4_COMPONENT_MAPPING(1, 0x00001688), 0x00000001)
	expect_value(t, d3d12.D3D12_DECODE_SHADER_4_COMPONENT_MAPPING(2, 0x00001688), 0x00000002)
	expect_value(t, d3d12.D3D12_DECODE_SHADER_4_COMPONENT_MAPPING(3, 0x00001688), 0x00000003)
}
