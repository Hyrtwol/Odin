...
verify_winuser :: proc(t: ^testing.T) {
	...
	// Window Class Styles
	expect_value(t, win32.CS_VREDRAW, 0x00000001)
	expect_value(t, win32.CS_HREDRAW, 0x00000002)
	expect_value(t, win32.CS_DBLCLKS, 0x00000008)
	expect_value(t, win32.CS_OWNDC, 0x00000020)
	expect_value(t, win32.CS_CLASSDC, 0x00000040)
	expect_value(t, win32.CS_PARENTDC, 0x00000080)
	expect_value(t, win32.CS_NOCLOSE, 0x00000200)
	expect_value(t, win32.CS_SAVEBITS, 0x00000800)
	expect_value(t, win32.CS_BYTEALIGNCLIENT, 0x00001000)
	expect_value(t, win32.CS_BYTEALIGNWINDOW, 0x00002000)
	expect_value(t, win32.CS_GLOBALCLASS, 0x00004000)
	expect_value(t, win32.CS_DROPSHADOW, 0x00020000)
	// Window Styles
	...
	expect_value(t, win32.WS_EX_ACCEPTFILES, 0x00000010)
	expect_value(t, win32.WS_EX_APPWINDOW, 0x00040000)
	expect_value(t, win32.WS_EX_CLIENTEDGE, 0x00000200)
	expect_value(t, win32.WS_EX_COMPOSITED, 0x02000000)
	expect_value(t, win32.WS_EX_CONTEXTHELP, 0x00000400)
	expect_value(t, win32.WS_EX_CONTROLPARENT, 0x00010000)
	expect_value(t, win32.WS_EX_DLGMODALFRAME, 0x00000001)
	expect_value(t, win32.WS_EX_LAYERED, 0x00080000)
	expect_value(t, win32.WS_EX_LAYOUTRTL, 0x00400000)
	expect_value(t, win32.WS_EX_LEFT, 0x00000000)
	expect_value(t, win32.WS_EX_LEFTSCROLLBAR, 0x00004000)
	expect_value(t, win32.WS_EX_LTRREADING, 0x00000000)
	expect_value(t, win32.WS_EX_MDICHILD, 0x00000040)
	expect_value(t, win32.WS_EX_NOACTIVATE, 0x08000000)
	expect_value(t, win32.WS_EX_NOINHERITLAYOUT, 0x00100000)
	expect_value(t, win32.WS_EX_NOPARENTNOTIFY, 0x00000004)
	expect_value(t, win32.WS_EX_NOREDIRECTIONBITMAP, 0x00200000)
	expect_value(t, win32.WS_EX_OVERLAPPEDWINDOW, 0x00000300)
	expect_value(t, win32.WS_EX_PALETTEWINDOW, 0x00000188)
	expect_value(t, win32.WS_EX_RIGHT, 0x00001000)
	expect_value(t, win32.WS_EX_RIGHTSCROLLBAR, 0x00000000)
	expect_value(t, win32.WS_EX_RTLREADING, 0x00002000)
	expect_value(t, win32.WS_EX_STATICEDGE, 0x00020000)
	expect_value(t, win32.WS_EX_TOOLWINDOW, 0x00000080)
	expect_value(t, win32.WS_EX_TOPMOST, 0x00000008)
	expect_value(t, win32.WS_EX_TRANSPARENT, 0x00000020)
	expect_value(t, win32.WS_EX_WINDOWEDGE, 0x00000100)
}
