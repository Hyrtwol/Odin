...
hostfxr_main_fn :: #type proc(argc: int, argv: ^^char_t) -> int32_t
...
hostfxr_error_writer_fn :: #type proc(message: ^char_t)
...
hostfxr_dotnet_environment_info :: struct {
    ...
    hostfxr_version: ^char_t,
    hostfxr_commit_hash: ^char_t,
